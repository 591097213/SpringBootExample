...
import com.ccj.homework.homeworktest2.other.staticdata.Authorization;
...
public class AuthorizationInterceptorAdapter extends HandlerInterceptorAdapter {
    ...
    @Autowired
    Authorization authorizationTool;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        String[] result = authorizationTool.judgeAppidAndAppSecret(authorization);
