...
public class RandomUtils {
    ...
    public static boolean getSex() {
        return getRandomNumber(0, 1) == 0 ? true : false;
    }
        ...
        if (type == null || type.length == 0) {
            ...
            for (CharType str_type : type) {
                if (str_type.equals(CharType.LowerCase)) {
                    base.append(lowercase);
                } else if (str_type.equals(CharType.UpperCase)) {
                    base.append(uppercase);
                } else if (str_type.equals(CharType.Number)) {
                    base.append(num);
                }
            }
        }
    ...
    public static String getEmail(int lMin, int lMax) {
        ...
        StringBuffer sb = new StringBuffer();
        String str = getStr(length, CharType.LowerCase, CharType.Number);
        sb.append(str);
